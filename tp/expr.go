...
var exprAct = [...]int{
	...
	6, 11, 9, 15, 26, 16, 8, 22, 33, 17,
	19, 18, 20, 15, 10, 16, 24, 27, 25, 17,
	19, 18, 20, 15, 29, 16, 1, 30, 32, 17,
	19, 18, 20, 28, 34, 7, 8, 21, 8, 5,
	14, 4, 31, 23, 3, 2, 13, 12,
}
var exprPact = [...]int{

	35, -1000, -1000, -1000, 28, 9, 30, -1000, -2, 38,
	-1000, 8, -1000, -1000, -1000, -1, 26, -1000, -1000, -1000,
	-1000, -1000, 19, -1000, 19, 37, -1000, 21, -1000, 0,
	-1000, -1000, -1000, -4, -1000,
}
var exprPgo = [...]int{

	0, 47, 2, 1, 46, 0, 45, 44, 40, 26,
}
var exprR1 = [...]int{
...
var exprChk = [...]int{
	...
	-1000, -9, -6, -7, 6, 4, -5, 7, 10, -2,
	5, -3, -1, -4, -8, 4, 6, 10, 12, 11,
	13, 7, 9, 5, 8, -2, 5, -5, 7, -3,
	-2, 5, 7, 8, -5,
}
var exprDef = [...]int{

	0, -2, 1, 2, 0, 0, 0, 4, 0, 0,
	6, 13, 15, 16, 17, 0, 0, 18, 19, 20,
	21, 3, 0, 5, 0, 0, 12, 0, 8, 9,
	14, 11, 7, 0, 10,
}
var exprTok1 = [...]int{
...
exprdefault:
	...
	case 4:
		...
		//line expr.y:54
		{
			exprVAL.f = func(level int) { fmt.Println("{}") }
		}
	case 5:
		exprDollar = exprS[exprpt-3 : exprpt+1]
		//line expr.y:58
